...
export default function Socials() {
  return (
    <div className="flex flex-col items-center lg:items-start">
      <div className="flex dark:hidden gap-4 lg:gap-0">
        <a
          href="https://x.com/yhbarve"
          target="_blank"
          className="hover:bg-zinc-200 p-2 rounded-md transition-colors ease-in-out"
        >
          <svg
      ...
      <div className="dark:flex dark:visible hidden dark:gap-4 lg:dark:gap-0">
        <a
          href="https://x.com/yhbarve"
          target="_blank"
          className="hover:bg-zinc-800 p-2 rounded-md transition-colors ease-in-out"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="0.90em"
