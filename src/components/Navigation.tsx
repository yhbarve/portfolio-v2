export default function Navigation(){
    return(
        <div className="pl-2 flex flex-col gap-4 text-navigation-link text-sm">
            ...
            <div className="hover:translate-x-1 transition-transform ease-in-out"><a href="/blogs">Writings →</a></div>
