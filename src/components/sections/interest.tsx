    ...
    return (
        ...
        hover:text-card-hoverForeground transition duration-200 ease-in-out rounded-md p-2 cursor-default hover:backdrop-blur-2xl">
                    ...
                    <div className="col-span-4 flex flex-col">
                        ...
                        <div className="font-light text-sm"><div className="font-normal inline">Description: </div>I have a strong attention to detail. I also managed an F1 Instagram page called <a href="https://www.instagram.com/onef1_official/" className="underline">OneF1</a> for a year in 2022. The page has around 100 followers. I designed posts about race weeks, driver standings, track stats, and F1 news using Canva. I constantly experimented with new layouts and kept improving the quality of the posts. Eventually, I decided to take a break because I found myself spending too much time on designing posts.
                        </div>                   
                    </div>
                </div>
            </div>
