...
const INTEREST_DETAILS: InterestInfo[] = [
  ...
  },
  {
    ...
    description: (
      <>
        I got into Leetcoding when preparing for interviews. But I really enjoyed the process, and it's been a hobby of mine ever since. Check out my <Link href="/puzzles" className="underline underline-offset-4 hover:text-accent" target="_blank">Puzzles</Link> page for some of my favorite problems.
      </>
    ),
  },
];
