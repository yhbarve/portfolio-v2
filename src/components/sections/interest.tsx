    ...
    return (
        ...
        hover:text-card-hoverForeground transition duration-200 ease-in-out rounded-md p-2 cursor-default hover:backdrop-blur-2xl">
                    ...
                    <div className="col-span-4 flex flex-col">
                        <div>Reading</div>
                        <div className="font-light text-sm"><div className="font-normal inline">Description: </div>I’ve been reading regularly since 2023, aiming for at least one book every month. I started out with audiobooks on Audible, but eventually transitioned to reading on my iPad. While I usually read non-fiction, I’ve now moved on to more technical books and textbooks related to computer science and mathematics. Here's my <a href="/reading" className="underline">reading collection</a>.</div>                   
                    </div>
                </div>
                <InterestCard index="02" title="Formula 1" desc="I've been an avid Formula 1 fan since 2018. The first race I ever watched live on TV was the 2018 Belgian Grand Prix, and since then I haven’t missed a single one. I’ve also gone back to rewatch all the key races since 2010 and dived into the sport’s past, so now I know F1 history all the way back to the 70s and 80s. I'm a fan of Charles Leclerc and Scuderia Ferrari, despite all the stress and heartbreaks that come with it. Beyond just watching, I dive deep into the technical side of F1, like tyre strategies, race tactics, and car setups. I also play the official F1 games on PS5 with a full pro sim setup, which means I know every circuit inside out. That experience makes watching the races even more immersive and exciting for me." />
