...
export default function Interest({interests}:{interests:Array<string>}){
    return (
        <div className="mt-24">
            <div className="text-sm font-bold pb-4 pl-2">INTERESTS</div>
            <div className="flex flex-col gap-4 dark:hover:text-zinc-400 hover:text-zinc-500">
                ...
                <InterestCard index="03" title="Graphic Design" desc="I have a strong attention to detail. I also managed an F1 Instagram page called 'OneF1' for a year in 2022. The page has around 100 followers. I designed posts about race weeks, driver standings, track stats, and F1 news using Canva. I constantly experimented with new layouts and kept improving the quality of the posts. Eventually, I decided to take a break because I found myself spending too much time on designing posts." />
            </div>
        </div>
    )
}