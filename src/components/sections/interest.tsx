...
export default function Interest({interests}:{interests:Array<string>}){
    return (
        <div id="interests" className="mt-12">
         ...
         transition duration-200 ease-in-out rounded-md p-2 cursor-default hover:backdrop-blur-2xl">
                    <div className="col-span-1 flex flex-col">
                        <div className="font-light max-w-[90%]">01</div>
                    </div>
                    <div className="col-span-4 flex flex-col">
                        <div className="text-section-header">Reading</div>
         ...
         transition duration-200 ease-in-out rounded-md p-2 cursor-default hover:backdrop-blur-2xl">
                    ...
                    <div className="col-span-4 flex flex-col">
                        <div className="text-section-header">Graphic Design</div>
