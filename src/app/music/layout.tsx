...
export default function MusicLayout({ children }: { children: ReactNode }) {
  return (
    <div className="scroll-smooth bg-gradient-to-tr from-background-1 via-background-2 to-background-3 transition duration-200 ease-in-out">
      <div className="mx-auto min-h-screen max-w-screen-xl px-3 py-6 font-sans md:px-12 md:py-12 lg:px-24 lg:py-0">
        <div className="pt-4 lg:pt-12">
          ...
          <h1 className="text-4xl lg:text-5xl font-semibold text-page-titleForeground inline-block pb-3 mt-2">
            Favorite Music
          </h1>
        </div>
        {children}
